  ...
  return (
    <>
      <style>{`
        ...
        .home { color: #fff; font-family: 'Syne', sans-serif; }
        .hero {
          min-height: 100vh; display: flex; align-items: center; justify-content: center;
          background: radial-gradient(ellipse 80% 60% at 50% 0%, rgba(255,200,50,0.12) 0%, transparent 70%), #0a0a0f;
        ...
        .hero-badge {
          ...
          color: #FFC832; padding: 6px 16px; border-radius: 40px; font-size: 0.8rem;
        ...
        .hero-title em { font-family: 'Crimson Pro', serif; font-style: italic; color: #FFC832; font-size: 1.1em; }
        .hero-sub {
        ...
        .btn-primary {
          padding: 14px 32px; background: #FFC832; color: #0a0a0f; border: none;
        ...
        .btn-primary:hover { background: #e6b22e; transform: translateY(-2px); box-shadow: 0 8px 24px rgba(255,200,50,0.3); }
        .btn-ghost {
          padding: 14px 32px; background: transparent; color: rgba(255,255,255,0.7);
          border: 1.5px solid rgba(255,255,255,0.15); border-radius: 12px; font-size: 1rem;
        ...
        .stat-item { background: #0f0f1a; padding: 28px 24px; text-align: center; }
        .stat-num { font-size: 2rem; font-weight: 800; color: #FFC832; }
        .stat-label { font-size: 0.8rem; color: rgba(255,255,255,0.4); font-weight: 500; margin-top: 4px; }
        .section { padding: 100px 24px; }
        .section-inner { max-width: 1200px; margin: 0 auto; }
        .section-title { font-size: clamp(1.8rem, 4vw, 2.8rem); font-weight: 800; margin-bottom: 12px; letter-spacing: -0.03em; }
        .section-title span { color: #FFC832; }
        .section-sub { color: rgba(255,255,255,0.45); margin-bottom: 56px; font-size: 1rem; }
        .features-grid { display: grid; grid-template-columns: repeat(auto-fit, minmax(260px, 1fr)); gap: 1px; background: rgba(255,255,255,0.06); border-radius: 20px; overflow: hidden; }
        .feature-card { background: #0d0d1a; padding: 36px 28px; }
        .feature-icon { font-size: 2rem; margin-bottom: 16px; }
        .feature-title { font-size: 1.1rem; font-weight: 700; margin-bottom: 10px; }
        .feature-desc { color: rgba(255,255,255,0.45); font-size: 0.875rem; line-height: 1.7; }
        .cta-section {
        ...
        .cta-sub { color: rgba(255,255,255,0.5); margin-bottom: 32px; }
