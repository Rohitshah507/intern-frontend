    ...
    <>
      ...
      <div className="mb-page">
        <div className="mb-inner">
          ...
          {error && <div className="empty" style={{color:"#b42318"}}>{error}</div>}
          {!loading && !error && (
                ...
                <div className="booking-card" key={b._id}>
                  <div className="bc-header">
                    <div>
                      ...
                      <div style={{fontSize:"0.8rem",color:"var(--text-dim)",marginTop:"4px",fontWeight:700}}>Plate: {b.vehicleNumber}</div>
                    </div>
            ...
            }) : <div className="empty"><div style={{fontSize:"3rem",marginBottom:"16px"}}>📋</div><div>No bookings yet. <a href="/vehicles" style={{color:"#7a5a00",fontWeight:900,textDecoration:"none"}}>Browse vehicles</a></div></div>
          )}
        </div>
      </div>
      {payModal && (
        <div className="modal-overlay" onClick={e => e.target === e.currentTarget && setPayModal(null)}>
          <div className="modal">
            ...
            <div style={{background:"rgba(244,196,48,0.14)",borderRadius:"14px",padding:"14px",marginBottom:"20px",border:"1px dashed rgba(17,17,17,0.16)"}}>
              <div style={{fontSize:"0.8rem",color:"var(--text-dim)",fontWeight:900}}>Total Amount</div>
              <div style={{fontSize:"1.5rem",fontWeight:900,color:"#7a5a00"}}>Rs. {payModal.totalPrice?.toLocaleString()}</div>
            </div>
